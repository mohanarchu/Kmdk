...
import com.video.aashi.kmdk.Login.otp.SmsReceiver;
...
public class OtpVerification extends AppCompatActivity implements otpPresenter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otpValid = new OtpValid(OtpVerification.this,getApplicationContext());
    ...
    {
        Intent intent = new Intent(getApplicationContext(),MembersMain.class);
